    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtFilter) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/patients/*/medical-antecedents/**").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/v1/patients/*/medical-antecedents").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/v1/patients/*/emergency-contacts/**").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/v1/patients/*/emergency-contacts").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/v1/patients/*/medical-antecedents")
                        .hasAnyRole("ADMIN", "MEDECIN", "INFIRMIER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/patients/*/medical-antecedents/*")
                        .hasAnyRole("ADMIN", "MEDECIN", "INFIRMIER")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/patients/*/medical-antecedents/*")
                        .hasAnyRole("ADMIN", "MEDECIN")
                        .requestMatchers(HttpMethod.POST, "/api/v1/patients/*/emergency-contacts")
                        .hasAnyRole("ADMIN", "RECEPTION", "MEDECIN")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/patients/*/emergency-contacts/*")
                        .hasAnyRole("ADMIN", "RECEPTION", "MEDECIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/patients/*/emergency-contacts/*")
