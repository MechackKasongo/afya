        ...
        <Routes>
          ...
          <Route element={<ProtectedRoute />}>
            <Route element={<Layout />}>
              ...
              <Route element={<RoleRoute allowed={[...CLINICAL_STAFF]} />}>
                <Route element={<RoleRoute allowed={['ROLE_RECEPTION']} />}>
                  <Route path="/patients" element={<PatientsPage />} />
                  <Route path="/patients/new" element={<PatientCreatePage />} />
                </Route>
                <Route path="/patients/:id" element={<PatientDetailPage />} />
                <Route path="/admissions" element={<AdmissionsPage />} />
                <Route element={<RoleRoute allowed={['ROLE_RECEPTION', 'ROLE_MEDECIN']} />}>
                ...
                <Route path="/admissions/:id" element={<AdmissionStayLayout />}>
                  ...
                  <Route
                    path="vital-signs"
                    element={
                      <RoleRoute allowed={[...CLINICAL_CARE]}>
                  ...
                  <Route
                    path="prescriptions"
                    element={
                      <RoleRoute allowed={['ROLE_MEDECIN']}>
