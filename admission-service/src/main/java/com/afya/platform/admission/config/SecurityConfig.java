package com.afya.platform.admission.config;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtFilter) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .hasAnyRole("ADMIN", "MEDECIN")
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/admissions/*/notifications/*/read")
                        .authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/v1/urgences/**")
                        .hasAnyRole("ADMIN", "RECEPTION", "MEDECIN", "INFIRMIER")
                        .requestMatchers(HttpMethod.POST, "/api/v1/stays")
                        .hasAnyRole("ADMIN", "RECEPTION")
                        .requestMatchers(HttpMethod.POST, "/api/v1/stays/*/close", "/api/v1/stays/close-by-admission/**")
                        .hasAnyRole("ADMIN", "RECEPTION", "MEDECIN")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/stays/*/hospitalization-form")
                        .hasAnyRole("ADMIN", "RECEPTION", "MEDECIN", "INFIRMIER")
                        .anyRequest().denyAll())
