...
import com.afya.platform.bff.dto.AdmissionNotificationResponse;
import com.afya.platform.bff.dto.CareEntryVolumesResponse;
import com.afya.platform.bff.dto.AdmissionResponse;
import com.afya.platform.bff.dto.DischargeRecordResponse;
...
public class AdmissionClient {
    ...
    public DischargeRecordResponse getDischarge(Long id, String authorizationHeader) {
        return restClient.get()
                .uri("/api/v1/admissions/{id}/discharge", id)
                .headers(headers -> headers.addAll(AuthorizationSupport.bearerHeaders(authorizationHeader)))
                .retrieve()
                .body(DischargeRecordResponse.class);
    }

    public List<AdmissionNotificationResponse> listNotifications(Long id, String authorizationHeader) {
        return restClient.get()
                .uri("/api/v1/admissions/{id}/notifications", id)
                .headers(headers -> headers.addAll(AuthorizationSupport.bearerHeaders(authorizationHeader)))
                .retrieve()
                .body(RestClientTypes.list(AdmissionNotificationResponse.class));
    }
    ...
    public AdmissionNotificationResponse markNotificationRead(
        ...
        return restClient.patch()
                .uri("/api/v1/admissions/{id}/notifications/{notificationId}/read", admissionId, notificationId)
                .headers(headers -> headers.addAll(AuthorizationSupport.bearerHeaders(authorizationHeader)))
                .retrieve()
                .body(AdmissionNotificationResponse.class);
    }
