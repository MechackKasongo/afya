...
public class MedicalClient {
    ...
    public ConsultationResponse createConsultation(ConsultationCreateRequest request, String authorizationHeader) {
    ...
    public List<DiseaseCatalogResponse> listSelectableDiseases(String diseaseType, String authorizationHeader) {
        return restClient.get()
                .uri(uriBuilder -> uriBuilder.path("/api/v1/disease-catalog").queryParam("diseaseType", diseaseType).build())
                .headers(headers -> headers.addAll(AuthorizationSupport.bearerHeaders(authorizationHeader)))
                .retrieve()
                .body(RestClientTypes.list(DiseaseCatalogResponse.class));
    }

    public MedicalRecordResponse getMedicalRecord(Long patientId, boolean activePrescriptionsOnly, String authorizationHeader) {
        return restClient.get()
    ...
    public ClinicalNoteResponse addNote(Long patientId, ClinicalNoteRequest request, String authorizationHeader) {
        return restClient.post()
    ...
    public DiagnosisResponse addDiagnosis(Long patientId, DiagnosisRequest request, String authorizationHeader) {
        return restClient.post()
    ...
    public List<PrescriptionLineResponse> listPrescriptions(Long patientId, Boolean activeOnly, String authorizationHeader) {
        return restClient.get()
                .uri(uriBuilder -> uriBuilder
