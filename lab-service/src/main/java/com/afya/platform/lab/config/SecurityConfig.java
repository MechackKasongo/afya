    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/lab/exam-requests", "/api/v1/lab/exam-requests/**")
                        .hasAnyRole("ADMIN", "MEDECIN", "LABORANTIN")
                        .requestMatchers(HttpMethod.POST, "/api/v1/lab/exam-requests/*/specimen")
                        .hasAnyRole("ADMIN", "LABORANTIN")
                        .requestMatchers(HttpMethod.POST, "/api/v1/lab/exam-requests/*/result")
                        .hasAnyRole("ADMIN", "LABORANTIN")
                        .requestMatchers(HttpMethod.POST, "/api/v1/lab/exam-requests/*/postpone")
                        .hasAnyRole("ADMIN", "LABORANTIN")
                        .requestMatchers(HttpMethod.POST, "/api/v1/lab/exam-requests/*/reactivate")
                        .hasAnyRole("ADMIN", "MEDECIN", "LABORANTIN")
                        .anyRequest().denyAll())
